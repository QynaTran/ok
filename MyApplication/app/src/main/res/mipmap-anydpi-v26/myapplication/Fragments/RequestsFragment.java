...
public class RequestsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Users, RequestViewHolder> adapter=new FirebaseRecyclerAdapter<Users, RequestViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@androidx.annotation.NonNull final RequestViewHolder requestViewHolder, int i, @androidx.annotation.NonNull Users users) {
            ...
            @Override
            public RequestViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder{
        ...
        public RequestViewHolder(@androidx.annotation.NonNull View itemView) {
            super(itemView);
            mView = itemView;
