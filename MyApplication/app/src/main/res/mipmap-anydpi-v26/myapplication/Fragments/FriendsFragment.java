...
public class FriendsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Friends,FriendsViewHolder> adapter=new FirebaseRecyclerAdapter<Friends, FriendsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@androidx.annotation.NonNull final FriendsViewHolder friendsViewHolder, int i, @androidx.annotation.NonNull Friends friends) {
    ...
    public static class FriendsViewHolder extends RecyclerView.ViewHolder{
        ...
        public FriendsViewHolder(@androidx.annotation.NonNull View itemView) {
            super(itemView);
            mView = itemView;
